...
class RectangularSelectionTool : public QWidget
{
    Q_OBJECT
public:
    explicit RectangularSelectionTool(UIManager* ui, QWidget* parent = nullptr);
...
signals:
    void rectangularSelectionToolDisabled();
